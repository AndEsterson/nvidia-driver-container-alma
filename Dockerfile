...
RUN rpm -i --nodeps ${RPM_BASE_URL}/elfutils-libelf-0.190-2.el9.x86_64.rpm
RUN rpm -i --nodeps ${RPM_BASE_URL}/kernel-devel-${KERNEL_VERSION}.rpm
RUN rpm -i --nodeps ${RPM_BASE_URL}/linux-firmware-20230824-119.git0e048b06.el8_9.noarch.rpm
RUN rpm -i --nodeps ${RPM_BASE_URL}/kernel-core-${KERNEL_VERSION}.rpm
